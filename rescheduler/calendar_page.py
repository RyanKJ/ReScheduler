...
10) Fix date entry class: bugs with deletion
11) Change instantiated calendar upon starting program to be next month 
    of current datetime.datetime.now() month
12) Redesign calc_widgets to be more efficient: 1 Query to DB then process?
13*) Get some type of regex for day_widget title in schedule area
14*) Add optional arg to TimeEntry for setting default values: kwargs?
15*) Change application icon
16) Refactor into MVC design: CalendarCalc, EmployeePage, SalesPage
